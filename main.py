...
def main():
    ...
    while True:
        db_choice = input("Enter your choice (1 for MySQL, 2 for MongoDB): ").strip()
...
def mongo_main():
    ...
    while True:
        print("\nCommands: upload dataset, explore data, sample queries, query, exit") # prompt user to select a command
        cmd = input("Enter a command: ").strip().lower()
